...
namespace QuanTriKhachSanN5.Controllers.Disabled
{
    ...
    public class BookingsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAvailablePhysicalRooms([FromQuery] int roomTypeId, [FromQuery] DateTime checkIn, [FromQuery] DateTime checkOut)
        {
            var result = await _bookingService.GetAvailablePhysicalRoomsAsync(roomTypeId, checkIn, checkOut);
            return Ok(result);
        }
    }
}