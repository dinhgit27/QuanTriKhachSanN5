...
public static class SeedData
{
    ...
    public static void Initialize(ApplicationDbContext context)
    {
        ...
        if (!context.Vouchers.Any())
        {
            ...
            {
                new Voucher { Code = "GIAMGIA10", DiscountPercent = 10.0m, IsActive = true },
                new Voucher { Code = "GIAMGIA20", DiscountPercent = 20.0m, IsActive = true },
                new Voucher { Code = "WELCOME50", DiscountPercent = 50.0m, IsActive = true },
                new Voucher { Code = "VIP100", DiscountPercent = 100.0m, IsActive = true },
                new Voucher { Code = "HETHAUD15", DiscountPercent = 15.0m, IsActive = false }
            };
        ...
        if (vouchers.Any()) Console.WriteLine($"   - {vouchers.Count} mã giảm giá");
    }
}
